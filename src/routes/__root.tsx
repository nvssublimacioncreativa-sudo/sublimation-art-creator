  ...
  head: () => ({
    meta: [
      ...
      { title: "Sublimarte — Generador de imágenes para sublimar con IA" },
      {
        name: "description",
        content:
          "Crea diseños PNG listos para sublimar en tazas, playeras y más. Plantillas de Día del Padre, Mundial 2026 y diseños personalizados con IA.",
      },
      ...
      { property: "og:description", content: "Crea diseños PNG listos para sublimar en tazas, playeras y más con IA." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Sublimarte" },
      { property: "og:url", content: "https://sublimation-art-creator.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sublimarte — Imágenes para sublimar con IA" },
      { name: "twitter:description", content: "Genera diseños PNG listos para sublimar con IA." },
    ],
    links: [
